(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("vue-wc-compose", [], factory);
	else if(typeof exports === 'object')
		exports["vue-wc-compose"] = factory();
	else
		root["vue-wc-compose"] = factory();
})(window, function() {
...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/vue-wc-compose.js");
/******/ })
/************************************************************************/
/******/ ({
...
/*!**********************!*\
  !*** ./package.json ***!
  \**********************/
/*! exports provided: name, version, description, main, scripts, keywords, author, license, publishConfig, repository, dependencies, devDependencies, peerDependencies, browserslist, default */
/***/ (function(module) {

module.exports = JSON.parse("{\"name\":\"vue-wc-compose\",\"version\":\"1.2.1\",\"description\":\"Compose hosted vue components and web components\",\"main\":\"index.js\",\"scripts\":{\"build\":\"webpack --mode=production\",\"dev\":\"webpack --mode=development --watch\",\"demo\":\"http-server . -p 9999\",\"demo:build\":\"node ./demo/components/build.js\",\"prepublishOnly\":\"concurrently \\\"npm run build\\\" \\\"webpack --mode=development\\\"\"},\"keywords\":[\"vue\",\"compose\",\"ui\",\"web components\"],\"author\":\"Austin Martin (auz.martin@gmail.com)\",\"license\":\"ISC\",\"publishConfig\":{\"registry\":\"https://registry.npmjs.org/\"},\"repository\":{\"type\":\"git\",\"url\":\"git+https://github.com/auzmartist/vue-wc-compose.git\"},\"dependencies\":{\"vue-custom-element\":\"^3.2.6\",\"webpack-merge\":\"^4.1.4\"},\"devDependencies\":{\"@babel/cli\":\"^7.8.4\",\"@babel/core\":\"^7.8.6\",\"@babel/plugin-proposal-class-properties\":\"^7.8.3\",\"@babel/plugin-proposal-object-rest-spread\":\"^7.8.3\",\"@babel/preset-env\":\"^7.8.6\",\"@babel/preset-typescript\":\"^7.8.3\",\"babel-loader\":\"^8.0.6\",\"css-loader\":\"^3.4.2\",\"http-server\":\"^0.12.1\",\"style-loader\":\"^1.1.3\",\"concurrently\":\"^5.1.0\",\"core-js\":\"^3.6.4\",\"regenerator-runtime\":\"0.13.3\",\"typescript\":\"^3.8.3\",\"webpack\":\"^4.42.0\",\"webpack-cli\":\"^3.3.11\",\"vue-loader\":\"^15.9.0\",\"vue\":\"^2.6.11\",\"vue-template-compiler\":\"^2.6.11\"},\"peerDependencies\":{\"webpack\":\"^4.27.0\"},\"browserslist\":[\"> 1%\",\"last 2 versions\",\"ie 11\"]}");

/***/ }),

/***/ "./src/vue-wc-compose.js":
/*!*******************************!*\
  !*** ./src/vue-wc-compose.js ***!
  \*******************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = ((function () {
  ...
  var componentNotFound = function componentNotFound(name, error) {
    return {
      name: 'notFound',
      ...
      render: function render(h) {
        ...
        }, [h('span', null, [h('b', null, "'".concat(name, "' not found"))])]);
      }
    };
  };
  ...
  function install(vue, options) {
    ...
    Vue.use(vue_custom_element__WEBPACK_IMPORTED_MODULE_9__["default"]);
    options = options || {};
    applyMixin(Vue);
  }
  ...
  function _loadComponents() {
    _loadComponents = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
      var _this = this;
            ...
            case 0:
              if (this.$options.compose) {
                _loop = function _loop(name) {
                  ...
                  var template = _this.$options.compose[name];
                  ...
                  switch (template.type.toLowerCase()) {
                    ...
                    case 'vc':
                      ...
                      Vue.component(name, function (resolve) {
                        return loadRemoteComponent(name, template.src).then(resolve);
                      });
                      break;

                    case 'wc':
                      loadRemoteComponent(name, template.src).then(function (factoryFn) {
                ...
                for (name in this.$options.compose) {
                  _loop(name);
                }
              }
  ...
  function loadRemoteComponent(name, src) {
    return new Promise(function (res, rej) {
      var scriptName = src.split('/').pop().replace(/(.min)?.js/i, '');
      var scriptId = "wc_".concat(scriptName);
      ...
      s.onerror = function (e) {
        return res(componentNotFound(name, e));
      };
  ...
  return {
    name: _package_json__WEBPACK_IMPORTED_MODULE_10__.name,
...
//# sourceMappingURL=vue-wc-compose.js.map